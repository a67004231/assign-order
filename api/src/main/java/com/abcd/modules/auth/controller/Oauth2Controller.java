...
import com.abcd.modules.auth.vo.Oauth2TokenInfo;
...
//    @Autowired
//    private IMemberUsersService memberUsersService;
    ...
    public Result<Object> authorize(@ApiParam("登录名") @RequestParam String loginName,
        ...
        /**根据登录名获取会员信息*/
//        QueryWrapper<MemberUsers> queryWrapper = new QueryWrapper<>();
//        queryWrapper.lambda().eq(MemberUsers::getLoginName,loginName);
//        MemberUsers memberUser = memberUsersService.getOne(queryWrapper);
//        if(memberUser==null){
//            return ResultUtil.error("会员信息不存在");
//        }
...
//        }
        ...
        // 存入用户及clientId信息
        redisTemplate.opsForValue().set("oauthCode:"+code, new Gson().toJson(new Oauth2TokenInfo(client_id, loginName)), 5L, TimeUnit.MINUTES);
