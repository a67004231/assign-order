...
import com.abcd.generator.bean.Entity;

import static com.abcd.generator.Generator.*;
...
public class MPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "OrderSetting";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "商户进单设置";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.ryhy.modules.order.entity";

    /**
     * dao对应包 【注意修改后需到com.ryhy.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.ryhy.modules.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.ryhy.modules.order.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.ryhy.modules.order.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.ryhy.modules.order.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/ryhy/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        entity.setTableName(tablePre+"_"+camel2Underline(className));
