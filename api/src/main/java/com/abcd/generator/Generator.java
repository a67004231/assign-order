...
public class Generator {
     ...
     * 建议仅需修改
     */
    private static final String className = "OrderInfo";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.ryhy.modules.your.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.ryhy.modules.your.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.ryhy.modules.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.ryhy.modules.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.ryhy.modules.your.controller";
