package com.abcd.config.security.jwt;

import cn.hutool.core.util.StrUtil;

import com.abcd.common.constant.SecurityConstant;
import com.abcd.common.utils.ResponseUtil;
import com.abcd.common.utils.SecurityUtil;
import com.abcd.common.vo.TokenUser;
import com.abcd.config.properties.TokenProperties;
...
public class JWTAuthenticationFilter extends BasicAuthenticationFilter   {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(String header, HttpServletResponse response) {
        ...
        if(tokenProperties.getRedis()){
            // redis
            String v = redisTemplate.opsForValue().get("oauthTokenInfo:" + header);
