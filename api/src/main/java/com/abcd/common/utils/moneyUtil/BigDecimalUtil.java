...
public class BigDecimalUtil {
	 ...
	 * @return
	 */
	public static String mulbyFormat(String d1, String d2) { // 进行乘法运算
		BigDecimal b1;
		BigDecimal b2;
		try {
			b1 = new BigDecimal(d1);
			...
			String format = multiply.setScale(0, BigDecimal.ROUND_HALF_UP).toString();
			return format;
		} catch (Exception e) {
			return "0";
		}
	...
	public static void main(String[] args) {
		BigDecimal b = new BigDecimal("111231.4585");
		long longValue = b.setScale(0, BigDecimal.ROUND_HALF_UP).longValue();
